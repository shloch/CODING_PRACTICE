...
m - number of rows;
n - number of columns;
position - object (associative array in PHP) containing two properties - x and y.
Example:
...
function createGrid(m, n, position) {
  //console.log(`m= ${m}, n=${n}, position=x:${position.x}, y:${position.y}`)
   let solution = ''
