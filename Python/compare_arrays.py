...
#  of 19, 25921 the square of 161, and so on. It gets obvious
...
# EXERCISE --> https://www.codewars.com/kata/550498447451fbbd7600041c/train/python

def comp(array1, array2):
    if array1 == None or array2 == None:
        return False
    sq_array1 = [x**2 for x in array1]
    sq_array1.sort()
    array2.sort()
    return sq_array1 == array2
